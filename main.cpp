...
int main(int argc, char* argv[]) {
    ...
    if (menuOption == 1) {
        ...
        if (rand() % 1000 < 1) { // Xác suất sinh ra kẻ địch mới
        ...
        renderExplosions(renderer, explosions, MAX_EXPLOSIONS); // Render hiệu ứng nổ
        // **Render điểm số**
        ...
        std::cout << "Huong dan choi!" << std::endl;
        Mix_PlayMusic(backgroundMusic, -1);
        ...
        std::cout << "Thoat tro choi!" << std::endl;
        isPlaying = false ;
        }
    }
